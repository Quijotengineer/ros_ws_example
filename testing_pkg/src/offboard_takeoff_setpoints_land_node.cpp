...
class OffboardClient
{
    public:
        ...
        OffboardClient(ros::NodeHandle *nh)
        {
            ...
            set_position_msg.pose.position.z = FLIGHT_ALTITUDE; // Default 2.5
        }
...
{
    ros::init(argc, argv, "offboard_takeoff_setpoints_land_node");
    ros::NodeHandle nh;
    ...
    while(ros::ok())
    {
        ...
        while (OffboardClient_object.current_state.armed && OffboardClient_object.current_state.mode == "OFFBOARD")
        {
            ...
            OffboardClient_object.set_position_msg.pose.position.x = X_OFFSET;
            OffboardClient_object.set_position_msg.pose.position.y = 0;
            OffboardClient_object.set_position_msg.pose.position.z = FLIGHT_ALTITUDE;
            ...
            // loop_rate.sleep();
            // }
            while(abs(OffboardClient_object.current_pose.pose.position.z - 
            ...
            OffboardClient_object.set_position_msg.pose.position.x = X_OFFSET;
            OffboardClient_object.set_position_msg.pose.position.y = DISPLACEMENT;
            OffboardClient_object.set_position_msg.pose.position.z = FLIGHT_ALTITUDE;
            ...
            // loop_rate.sleep();
            // }
            while(abs(OffboardClient_object.current_pose.pose.position.y - 
                      OffboardClient_object.set_position_msg.pose.position.y) > TOLERANCE)
            {
                OffboardClient_object.set_local_pos_pub.publish(OffboardClient_object.set_position_msg);
                ros::spinOnce();
                loop_rate.sleep();
            }
            ROS_INFO("Reached second waypoint!");

            // go to the third waypoint
            OffboardClient_object.set_position_msg.pose.position.x = X_OFFSET + DISPLACEMENT;
            OffboardClient_object.set_position_msg.pose.position.y = DISPLACEMENT;
            OffboardClient_object.set_position_msg.pose.position.z = FLIGHT_ALTITUDE;
            ...
            // loop_rate.sleep();
            // }
            while(abs(OffboardClient_object.current_pose.pose.position.x - 
                      OffboardClient_object.set_position_msg.pose.position.x) > TOLERANCE)
            {
                OffboardClient_object.set_local_pos_pub.publish(OffboardClient_object.set_position_msg);
                ros::spinOnce();
                loop_rate.sleep();
            }
            ROS_INFO("Reached third waypoint!");
            
            // go to the fourth waypoint
            OffboardClient_object.set_position_msg.pose.position.x = X_OFFSET + DISPLACEMENT;
            OffboardClient_object.set_position_msg.pose.position.y = 0;
            OffboardClient_object.set_position_msg.pose.position.z = FLIGHT_ALTITUDE;
            ...
            ROS_INFO("Reached fourth waypoint!");
            ...
            ROS_INFO("Reached starting waypoint!");
